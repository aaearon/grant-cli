// This file is in the external test package (config_test) on purpose: the
// testenv helper imports internal/config, so an in-package test file importing
...
// package can never touch the developer's real ~/.grant or ~/.idsec.
